...
function CallJS(jsStr) { //v2.0
	...
	//get the selected event name from the select box
	var hidden_selected_value=document.getElementById('selected_event_zip').value;


  if(document.getElementById('edit-file1').value=='' || hidden_selected_value=='' || hidden_selected_value=='select_event')
  {
	if(document.getElementById('edit-file1').value=='')
    		alert('Please upload a zip file!');

	else if(hidden_selected_value=='')
